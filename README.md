...
│   │
│   ├── handlers/
│   │   └── search.go            # Search orchestration (Fan-out/Fan-in)
│   │
│   ├── fetchers/
│   │   ├── github.go            # GitHub API client
│   │   ├── stackoverflow.go     # StackOverflow API client
│   │   └── reddit.go            # Reddit API client
│   │
│   ├── models/
│   │   └── result.go            # Internal result structures
│   │
│   └── config/
│       └── config.go            # Configuration loader (.env)
│
├── proto/
│   ├── search.proto             # Protocol Buffer definitions
│   ├── search.pb.go             # Generated: message definitions
│   └── search_grpc.pb.go        # Generated: gRPC service code
│
...
├── README.md                     # This file
├── GRPC_GUIDE.md                 # Learn gRPC (tutorial)
